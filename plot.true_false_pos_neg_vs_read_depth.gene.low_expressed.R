...
prefix_false_pos <- file.path(root, "plots", "sim.gene.false_pos_vs_read_depth.low_expressed")
prefix_false_neg <- file.path(root, "plots", "sim.gene.false_neg_vs_read_depth.low_expressed")
prefix_true_pos <- file.path(root, "plots", "sim.gene.true_pos_vs_read_depth.low_expressed")
prefix_true_neg <- file.path(root, "plots", "sim.gene.true_neg_vs_read_depth.low_expressed")
