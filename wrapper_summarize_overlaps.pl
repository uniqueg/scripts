...
### Requirements: n/a
#==================#
### Description: Writes and submits jobs for summarize_overlaps.R
...
#================#
#---> MAIN VARIABLES <---#
my $job_name_base_pl = '/import/bc2/home/zavolan/kanitz/AS/GSE41716/sra/jobs/summarize_overlaps';
...
## COMMANDS
time $Rscript $s_dir/summarize_overlaps.R $bam_dir $bed_dir/hg19_exon_coordinates.bed $gen $mode $o_dir/summarized_overlaps_hg19_exons_abyzov_' . $dir . '.R
