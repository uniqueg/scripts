...
prefix_false_pos <- file.path(root, "plots", "sim.trx.false_pos_vs_read_depth.all")
prefix_false_neg <- file.path(root, "plots", "sim.trx.false_neg_vs_read_depth.all")
prefix_true_pos <- file.path(root, "plots", "sim.trx.true_pos_vs_read_depth.all")
prefix_true_neg <- file.path(root, "plots", "sim.trx.true_neg_vs_read_depth.all")
