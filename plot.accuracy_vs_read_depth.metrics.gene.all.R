...
prefix_values <- file.path(root, "plots", "sim.gene.metrics.scaled_values.accuracy_vs_read_depth.all")
prefix_ranks <- file.path(root, "plots", "sim.gene.metrics.ranks.accuracy_vs_read_depth.all")
