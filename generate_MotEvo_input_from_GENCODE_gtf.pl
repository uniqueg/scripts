...
#==================#
### Description: Generates a MotEvo compatible regions file from a GENCODE GTF annotation file; feature types (e.g. "exon", "transcript") can be selected as well as flanking regions etc. selected
...
### Usage: perl ./perl generate_MotEvo_input_from_GENCODE_gtf.pl --usage for information on required and optional arguments
#==================#
#    HEADER END	   #
#==================#
...
#================#
#---> STATUS MESSAGE <---#
print "Starting 'generate_MotEvo_input_from_GENCODE_gtf.pl'...\n\n" unless $quiet;

#---> MAIN VARIABLES <---#
my ($region_AoH_ref, $region_type_HoH_ref);

#---> BODY <---#
$region_AoH_ref = gencode_gtf_to_AoH($gtf, @types);
$region_type_HoH_ref = gencode_gtf_AoH_to_region_type_HoH_ref($region_AoH_ref);
...
### Dependencies: n/a
### Type: Specialized
'Usage: perl ./generate_MotEvo_input_from_GENCODE_gtf.pl [OPTIONS] --gtf [FILE] --out_file [FILE]

Generates a MotEvo compatible regions file from a GENCODE GTF annotation file.
...
#-----------------------#
sub gencode_gtf_AoH_to_region_type_HoH_ref {
...
### Accepts: 1. Reference to region type hash of hashes generated by subroutine 'gencode_gtf_AoH_to_region_type_HoH_ref'
### Returns: n/a
### Dependencies: n/a
### Type: Specific
	#---> PASS ARGUMENTS <---#
