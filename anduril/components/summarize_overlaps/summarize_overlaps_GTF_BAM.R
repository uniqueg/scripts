...
option_list <- list(
		...
		make_option(c("-i", "--index"), action="store", type="character", default=FALSE, help="Index for BAM file, with or without '.bai' extension [DEFAULT: BAM filename and path]", metavar="bai file"),
