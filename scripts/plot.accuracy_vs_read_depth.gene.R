...
prefix_all <- file.path(root, "plots", "sim.gene.accuracy_vs_read_depth.all")
prefix_expressed <- file.path(root, "plots", "sim.gene.accuracy_vs_read_depth.expressed")
col_all <- 2
col_expressed <- 4
col_names <- c("sim_1", "sim_3", "sim_10", "sim_30", "sim_100")
select_all <- c("BitSeq", "BitSeq_no_priors", "CEM", "Cufflinks", "eXpress", "IsoEM", "MMSEQ", "MMSEQ_no_priors", "RSEM", "rSeq", "Sailfish", "Scripture", "TIGAR2", "Counting_Transcript", "Counting_Union_exon")
select_expressed <- c("BitSeq", "CEM", "Cufflinks", "eXpress", "IsoEM", "MMSEQ", "RSEM", "rSeq", "Sailfish", "Scripture", "TIGAR2", "Counting_Transcript", "Counting_Union_exon")
