...
prefix <- "sim"
suffix <- "bias_correction.accuracy.gene"
col_select <- c(2, 4)
col_names <- c("All genes, no bias correction", "All genes, bias correction", "Expressed genes, no bias correction", "Expressed genes, bias correction")
