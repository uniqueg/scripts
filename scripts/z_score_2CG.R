...
## INDUCED
# Load data
i <- read.table("distance_AsiSI_perm_hg19_induced_2CG_only", col.names = c("id", "distance"))
# Subset real pattern
...
## UNINDUCED
# Load data
u <- read.table("distance_AsiSI_perm_hg19_uninduced_2CG_only", col.names = c("id", "distance"))
# Subset real pattern
...
## Image
save.image(file = "z_scores_2CG.Rdata")
