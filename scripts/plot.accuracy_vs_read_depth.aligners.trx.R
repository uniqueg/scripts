...
prefix_all <- file.path(root, "plots", "sim.trx.mappers.accuracy_vs_read_depth.all")
prefix_expressed <- file.path(root, "plots", "sim.trx.mappers.accuracy_vs_read_depth.expressed")
col_all <- 2
col_expressed <- 4
...
## Generate plots ##
####################
plot_accuracy_depth(all_features, prefix_all, 0.3, colors=colors, chars=chars)
plot_accuracy_depth(expressed_features, prefix_expressed, 0.7, colors=colors, chars=chars)
