...
### Usage: perl ./remove_multi_mappers.pl for information on required and optional arguments
#==================#
#    HEADER END    #
#==================#
...
#================#
#---> STATUS MESSAGE <---#
print "Starting 'remove_multi_mappers.pl'...\n\n" unless $quiet;
...
### Type: Specialized
'Usage: perl ./remove_multi_mappers.pl [OPTIONS] --in [FILE|SAM] --uniq [FILE|SAM]
