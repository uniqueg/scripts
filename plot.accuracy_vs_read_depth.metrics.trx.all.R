...
prefix_values <- file.path(root, "plots", "sim.trx.metrics.scaled_values.accuracy_vs_read_depth.all")
prefix_ranks <- file.path(root, "plots", "sim.trx.metrics.ranks.accuracy_vs_read_depth.all")
